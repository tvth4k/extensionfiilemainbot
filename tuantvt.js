...
const login = require("fca-horizon-tvt"), moment = require("moment-timezone");
...
function checkBan(checkban) {
  ...
  return axios.get('https://raw.githubusercontent.com/tuantvtvip/fileadd/main/file%20extenson%20bot/data.json').then(dataGban => {
...
function onBot({ models: botModel }) {
  ...
  login(loginData, async(loginError, loginApiData) => {
      ...
      global.config.version = '31.40.12'
